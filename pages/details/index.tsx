                ...
                <div className="col-xl-3 col-lg-4 col-md-5 pb-30 pb-md-0 pe-md-25 text-md-start">
                    <div className="row align-items-center">
                        <div className="col-md-12 col-4">
                            <img src="/img/Thumbnail-3.png" width="280" height="380" className="img-fluid"
                                alt="" />
                        </div>
                        {/* <!-- Mobile: Game title --> */}
                                ...
                                <label className="col-lg-4 col-sm-6 ps-md-15 pe-md-15 pt-md-15 pb-md-15 pt-10 pb-10" for="topup1">
                                    ...
                                    <div className="detail-card">
                                        <div className="d-flex justify-content-between">
                                            <p className="text-3xl color-palette-1 m-0"><span
                                                    className="fw-medium">125</span>
                                                Gold
                                            </p>
                        ...
                        <div className="pb-md-50 pb-20">
                            ...
                            <fieldset id="paymentMethod">
                                <div className="row justify-content-between">
                                    ...
                                    <label className="col-lg-4 col-sm-6 ps-md-15 pe-md-15 pt-md-15 pb-md-15 pt-10 pb-10"
                                        for="visa">
                                        <input className="d-none" type="radio" id="visa" name="paymentMethod"
                                            value="visa" />
                                        <div className="detail-card">
                                            <div className="d-flex justify-content-between">
